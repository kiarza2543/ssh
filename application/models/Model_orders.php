...
class Model_orders extends CI_Model
{
	...
	public function create()
	{
    	...
    	$data = array(
    		...
    		'date_time' => strtotime(DateTime::createFromFormat('d/m/Y',$this->input->post('date_time'))->format('Y-m-d')),//strtotime(date('Y-m-d h:i:s a')),
    		'paid_status' => 2,
    		'user_id' => $user_id
    	);
	...
	public function update($id)
	{
		if($id) {
			...
			$data = array(
	    		...
	    		'customer_address' => $this->input->post('customer_address'),
				'customer_phone' => $this->input->post('customer_phone'),
				'date_time' => strtotime(DateTime::createFromFormat('d/m/Y',$this->input->post('date_time'))->format('Y-m-d')),
	    		'withdraw_from'=>$this->input->post('withdraw_from'),
