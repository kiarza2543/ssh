  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        จัดการ
        <small>ระดับผู้ใช้งาน</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> หน้าแรก</a></li>
        <li class="active">ระดับผู้ใช้งาน</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-md-12 col-xs-12">
          ...
          <?php if(in_array('createGroup', $user_permission)): ?>
            <a href="<?php echo base_url('groups/create') ?>" class="btn btn-primary">เพิ่มใหม่</a>
            <br /> <br />
          <?php endif; ?>

          <div class="box">
            <div class="box-header">
              <h3 class="box-title">จัดการระดับผู้ใช้งาน</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
