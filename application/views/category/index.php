...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      จัดการ
      <small>สายงานที่ควบคุมสิ่งอุปกรณ์</small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> หน้าแรก</a></li>
      <li class="active">สายงานที่ควบคุมสิ่งอุปกรณ์</li>
    </ol>
  </section>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">จัดการสายงานที่ควบคุมสิ่งอุปกรณ์</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-striped">
              <thead>
              <tr>
                <th>ชื่อสายงานที่ควบคุมสิ่งอุปกรณ์</th>
                <th>สกานะ</th>
      ...
      <form role="form" action="<?php echo base_url('category/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">ชื่อหมวดหมู่อุปกรณ์</label>
            <input type="text" class="form-control" id="category_name" name="category_name" placeholder="ป้อนหมวดหมู่อุปกรณ์" autocomplete="off">
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('category/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">ชื่อหมวดหมู่</label>
